...
public class EntryActivity extends SecuredActivity implements View.OnClickListener, BaseGeVisitContract.VisitView {
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        findViewById(R.id.ge_activity).setOnClickListener(this);
        findViewById(R.id.ge_home_visit).setOnClickListener(this);
        findViewById(R.id.ge_profile).setOnClickListener(this);
    }
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.ge_activity:
                startActivity(new Intent(this, GeRegisterActivity.class));
                break;
            case R.id.ge_home_visit:
                GeVisitActivity.startMe(this, "12345", false);
                break;
            case R.id.ge_profile:
                GeMemberProfileActivity.startMe(this, "12345");
                break;
            default:
                break;
        }
