package org.smartregister.chw.ge_sample.repository;
...
import org.smartregister.chw.ge_sample.application.SampleApplication;
...
public class SampleRepository extends Repository {
    ...
    public void onCreate(SQLiteDatabase database) {
        ...
        GeLibrary.getInstance().visitRepository().createTable(database);
        GeLibrary.getInstance().visitDetailsRepository().createTable(database);
