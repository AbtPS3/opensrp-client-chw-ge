...
@PrepareForTest(BaseGeCallDialogFragment.class)
public class BaseGeCallDialogFragmentTest {
    @Spy
    public BaseGeCallDialogFragment baseTestCallDialogFragment;
    ...
    public void setUp() {
        ...
        Whitebox.setInternalState(BaseGeCallDialogFragment.class, "MEMBER_OBJECT", memberObject);
    }
