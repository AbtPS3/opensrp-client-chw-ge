...
public class BaseGeProfileActivityTest {
    @Mock
    public BaseGeProfileActivity baseTestProfileActivity;

    @Mock
    public GeProfileContract.Presenter profilePresenter;
    ...
    public void formatTime() {
        BaseGeProfileActivity activity = new BaseGeProfileActivity();
        try {
    ...
    public void onClickBackPressed() {
        baseTestProfileActivity = Mockito.spy(new BaseGeProfileActivity());
