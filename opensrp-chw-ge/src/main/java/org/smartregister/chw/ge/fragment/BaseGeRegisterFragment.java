...
import org.smartregister.chw.ge.provider.GeRegisterProvider;
...
public class BaseGeRegisterFragment extends BaseRegisterFragment implements GeRegisterFragmentContract.View {
    public static final String CLICK_VIEW_NORMAL = "click_view_normal";
    public static final String FOLLOW_UP_VISIT = "follow_up_visit";

    @Override
    public void initializeAdapter(Set<View> visibleColumns) {
        GeRegisterProvider geRegisterProvider = new GeRegisterProvider(getActivity(), paginationViewHandler, registerActionHandler, visibleColumns);
        clientAdapter = new RecyclerViewPaginatedAdapter(null, geRegisterProvider, context().commonrepository(this.tablename));
    ...
    public void setupViews(android.view.View view) {
        ...
        if (titleView != null) {
            ...
            titleView.setText(getString(R.string.ge));
            titleView.setFontVariant(FontVariant.REGULAR);
        }
    }

    @Override
    public GeRegisterFragmentContract.Presenter presenter() {
        return (GeRegisterFragmentContract.Presenter) presenter;
    }
...
//        start forms here if the module requires registration
    ...
    protected void openProfile(String baseEntityId) {
        BaseGeProfileActivity.startProfileActivity(getActivity(), baseEntityId);
    }
