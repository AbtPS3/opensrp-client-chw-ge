...
import org.smartregister.chw.ge.util.ConfigHelper;
...
public class BaseGeRegisterFragmentModel implements GeRegisterFragmentContract.Model {

    @Override
    public RegisterConfiguration defaultRegisterConfiguration() {
        return ConfigHelper.defaultRegisterConfiguration(GeLibrary.getInstance().context().applicationContext());
    }
