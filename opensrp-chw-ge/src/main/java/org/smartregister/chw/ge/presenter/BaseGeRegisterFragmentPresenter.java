...
public class BaseGeRegisterFragmentPresenter implements GeRegisterFragmentContract.Presenter {

    protected WeakReference<GeRegisterFragmentContract.View> viewReference;
    ...
    public BaseGeRegisterFragmentPresenter(GeRegisterFragmentContract.View view, GeRegisterFragmentContract.Model model, String viewConfigurationIdentifier) {
    ...
    protected GeRegisterFragmentContract.View getView() {
