...
import org.smartregister.chw.ge.fragment.BaseHomeVisitFragment;
 ...
 */
public class BaseGeVisitAction {
    ...
    private GeVisitActionHelper geVisitActionHelper;
    private final Map<String, List<VisitDetail>> details;
    private final Context context;
    private final Validator validator;

    private BaseGeVisitAction(Builder builder) throws ValidationException {
        ...
        this.geVisitActionHelper = builder.geVisitActionHelper;
    ...
    private void initialize() {
        try {
            ...
            if (geVisitActionHelper != null) {
                geVisitActionHelper.onJsonFormLoaded(jsonPayload, context, details);
                String pre_processed = geVisitActionHelper.getPreProcessed();
                ...
                String sub_title = geVisitActionHelper.getPreProcessedSubTitle();
                if (StringUtils.isNotBlank(sub_title)) {
                    this.subTitle = sub_title;
                }

                ScheduleStatus status = geVisitActionHelper.getPreProcessedStatus();
                if (status != null) {
    ...
    private void onPayloadReceivedNotifyHelper(String jsonPayload) {
        ...
        geVisitActionHelper.onPayloadReceived(jsonPayload);

        String sub_title = geVisitActionHelper.evaluateSubTitle();
        if (sub_title != null) {
            setSubTitle(sub_title);
        }

        String post_process = geVisitActionHelper.postProcess(jsonPayload);
        if (post_process != null) {
            this.jsonPayload = geVisitActionHelper.postProcess(jsonPayload);
        }

        geVisitActionHelper.onPayloadReceived(this);
    }
    ...
    public GeVisitActionHelper getGeVisitActionHelper() {
        return geVisitActionHelper;
    }

    public void setGeVisitActionHelper(GeVisitActionHelper geVisitActionHelper) {
        this.geVisitActionHelper = geVisitActionHelper;
    }
    ...
    public void evaluateStatus() {
        ...
        if (getGeVisitActionHelper() != null) {
            setActionStatus(getGeVisitActionHelper().evaluateStatusOnPayload());
        }
    }

    public BaseGeVisitAction.Status computedStatus() {
    ...
    public interface GeVisitActionHelper {
         ...
         */
        void onPayloadReceived(BaseGeVisitAction baseGeVisitAction);
    }
    ...
    public static class Builder {
        ...
        public Builder withHelper(GeVisitActionHelper geVisitActionHelper) {
            this.geVisitActionHelper = geVisitActionHelper;
            return this;
        }
        ...
        public BaseGeVisitAction build() throws ValidationException {
            return new BaseGeVisitAction(this);
        }
    }
