package org.smartregister.chw.ge;
...
public class GeLibrary {
    private static GeLibrary instance;
    ...
    public static void init(Context context, Repository repository, int applicationVersion, int databaseVersion) {
        if (instance == null) {
            instance = new GeLibrary(context, repository, applicationVersion, databaseVersion);
        }
    }

    public static GeLibrary getInstance() {
        if (instance == null) {
    ...
    private GeLibrary(Context contextArg, Repository repositoryArg, int applicationVersion, int databaseVersion) {
